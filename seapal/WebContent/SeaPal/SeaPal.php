...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<noscript>
			<link rel="stylesheet" href="css_altitude/5grid/core.css" />
			<link rel="stylesheet" href="css_altitude/5grid/core-desktop.css" />
			<link rel="stylesheet" href="css_altitude/5grid/core-1200px.css" />
			<link rel="stylesheet" href="css_altitude/5grid/core-noscript.css" />
			<link rel="stylesheet" href="css_altitude/style.css" />
			<link rel="stylesheet" href="css_altitude/style-desktop.css" />
		</noscript>
		<script src="css_altitude/5grid/jquery.js"></script>
		<script src="css_altitude/5grid/init.js?use=mobile,desktop,1000px&amp;mobileUI=1&amp;mobileUI.theme=none&amp;mobileUI.openerWidth=52"></script>
			...
			<div class="5grid-layout">
				<div class="row">
					<div class="12u">
						<div id="banner">
							<div class="image-box">
								<img src="./SeaPal_files/SeaPal-Screen-Horiz01.jpg" width="970" height="320" alt="">
								<!--<div class="caption">
								<span>Phasellus Etiam Consequat Lorem Ipsum Etiam Veroeros</span><a href="#" class="button">Amet Consequat</a>
								</div>-->
							</div>
						</div>
					</div>
				...
				<div id="sidebar">
					<div id="box1">
						...
						<ul class="list-style1">
							...
							<li>
								<a href="http://seapal.de/about.php">About the project</a>
							</li>
							<li>
