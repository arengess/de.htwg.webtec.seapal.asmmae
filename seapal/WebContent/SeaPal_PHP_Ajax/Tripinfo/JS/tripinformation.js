$(function() {
    $('#form').keyup(function(e) {
        if (e.keyCode === 13) {
            ...
            trip = new Array(document.getElementById('registernr').value, document.getElementById('triptitle').value, document.getElementById('von').value, document.getElementById('nach').value, document.getElementById('skipper').value, document.getElementById('crew').value, document.getElementById('start').value, document.getElementById('ende').value, document.getElementById('dauer').value, document.getElementById('motor').value, tank, document.getElementById('notes').value);
            trip_send(trip);
        }
    });
});
