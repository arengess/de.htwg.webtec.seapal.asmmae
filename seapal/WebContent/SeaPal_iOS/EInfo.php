<html>
	<head> <title>E Info</title>
		<link rel="stylesheet" type="text/css" href="./css/Logbuch.css"></head>
	<body>
		<form>
			<fieldset>
			<div id="TInfoLinks">
			<p>Name<input type="text" name="name"/></p>
			<p>Position<input type="text" name="N1"/>�
			<input type="text" name="N2"/>'
			<input type="text" name="N3"/>"N
			<input type="text" name="E1"/>�
			<input type="text" name="E2"/>'
			<input type="text" name="E3"/>"E</p>
			<p>BTM<input type="text" name="BTM"/>DTM<input type="text" name="DTM"/></p>
			<p>Manoever<input type="text" name="Manoever"/></p>
			</div>
			 
			<p>COG<input type="text" name="COG"/>SOG<input type="text" name="SOG"/></p>
			
			<p>at</p>
			<p>Fahrt nach<select name="fahrtNach">
			...
			<p>Manoever<select name="Manoever">
				<option value="null">-</option>
			...
			Gro�segel<select name="fahrtNach">
				<option value="null">-</option>
