	...
	f.extend({
		...
		removeData : function(b, c, d) {
			if (!!f.acceptData(b)) {
				...
				delete h[i] : h[i] = null, k ? (h[i] = {}, g || (h[i].toJSON = f.noop), h[i][e] = k) : g && (f.support.deleteExpando ?
				delete b[f.expando] : b.removeAttribute ? b.removeAttribute(f.expando) : b[f.expando] = null)
			}
		},
			...
			if (a.nodeType !== 3 && a.nodeType !== 8) {
				...
				while ( h = c[k++]) {
					...
					if (p.length === 0 || e != null && p.length === 1)
						(!o.teardown || o.teardown.call(a, m) === !1) && f.removeEvent(a, h, s.handle), g = null,
						delete t[h]
				}
				if (f.isEmptyObject(t)) {
					...
					u && (u.elem = null),
					delete s.events,
					delete s.handle, f.isEmptyObject(s) && f.removeData(a, b, !0)
				}
			}
		},
		customEvent : {
		...
		cleanData : function(a) {
			...
			for (var i = 0, j; ( j = a[i]) != null; i++) {
				...
				if (c) {
					...
					h ?
					delete j[f.expando] : j.removeAttribute && j.removeAttribute(f.expando),
					delete d[c]
				}
			}
		}
